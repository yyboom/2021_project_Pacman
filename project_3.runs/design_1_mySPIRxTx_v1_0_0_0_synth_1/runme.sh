...
HD_PWD='C:/Xilinx/Vitis/project_11/project_11.runs/design_1_mySPIRxTx_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mySPIRxTx_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mySPIRxTx_v1_0_0_0.tcl
